...
test.describe('Basic Smoke Tests', () => {
  test('should load the home page', async ({ page }) => {
    ...
    await expect(page.locator('#drug-search h2')).toContainText('Step 1: Drug Search');
    
    // Verify workflow selection section
    await expect(page.locator('#workflow-selection h2')).toContainText('Step 2: Workflow Selection');
  ...
  test('should handle missing drug information in excel viewer', async ({ page }) => {
